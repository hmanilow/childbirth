...
<head>
    ...
    {{-- SEO Meta --}}
    <title>@yield('title', $defaultBrandTitle)</title>
    <meta name="description" content="@yield('description', $globalSettings['meta_description'] ?? $defaultDescription)">
    @yield('meta')

    {{-- Open Graph --}}
    <meta property="og:type" content="website">
    <meta property="og:title" content="@yield('og_title', $defaultBrandTitle)">
    <meta property="og:description" content="@yield('og_description', $globalSettings['meta_description'] ?? $defaultDescription)">
