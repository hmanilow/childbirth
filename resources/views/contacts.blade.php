...
@section('description', 'Связаться со школой материнства, подобрать курс или обсудить сопровождение родов в Москве и Московской области.')
...
<main>
    <section class="bg-bg-section pt-44 pb-16">
        <div class="container mx-auto px-4 sm:px-6 text-center">
            ...
            <p class="text-text-muted text-lg max-w-xl mx-auto">Напишите или позвоните — поможем выбрать курс или обсудить сопровождение.</p>
            <p class="mt-3 text-sm font-semibold text-gold-dark">Москва и Московская область</p>
        </div>
    </section>

    <section id="form" class="scroll-mt-40 py-16">
            ...
            <div class="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                ...
                <div class="space-y-8">
                    <div>
                        ...
                        <div class="space-y-5">
                            <a href="tel:{{ $phoneTel }}"
                               class="flex items-center gap-4 rounded-xl border border-border-soft bg-bg-card p-4 shadow-card transition-colors hover:border-accent-main/40 group">
                                <div class="w-10 h-10 bg-accent-main/10 rounded-lg flex items-center justify-center">
                                    <svg class="w-5 h-5 text-accent-main" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.3a1 1 0 01.95.68l1.5 4.5a1 1 0 01-.5 1.21l-2.25 1.13a11 11 0 005.48 5.48l1.13-2.25a1 1 0 011.21-.5l4.5 1.5a1 1 0 01.68.95V19a2 2 0 01-2 2h-1C9.72 21 3 14.28 3 6V5z"/>
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-text-primary font-medium group-hover:text-accent-main transition-colors">Позвонить</p>
...
@if($telegramUsername !== '')
                            <a href="https://t.me/{{ ltrim($telegramUsername, '@') }}"
                               class="flex items-center gap-4 rounded-xl border border-border-soft bg-bg-card p-4 shadow-card transition-colors hover:border-accent-main/40 group">
...
@endif
                    ...
                    <div class="rounded-xl border border-border-soft bg-bg-card p-5 shadow-card">
                        <p class="text-text-muted text-sm leading-relaxed">
                            ...
                            Работаем с семьями в Москве и Московской области.<br>
