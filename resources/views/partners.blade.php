...
@section('title', 'Партнёры — Школа материнства рожаем вместе')
@section('description', 'Специалисты и партнёры школы материнства: акушеры, психологи, консультанты по грудному вскармливанию.')
