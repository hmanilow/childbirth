                ...
                >
                    @php
                        $items = !empty($testimonials) ? $testimonials : [
                            ['name' => 'Анна К.', 'text' => 'Курс помог разложить подготовку по полочкам. Я поняла, что делать до родов и как задавать вопросы врачу.', 'rating' => 5, 'service' => 'Подготовка к родам'],
                            ...
                            ['name' => 'Екатерина В.', 'text' => 'Узнала столько нужного о родах, уходе за малышом и кормлении. Спасибо за такую понятную подачу!', 'rating' => 5, 'service' => 'Школа материнства'],
