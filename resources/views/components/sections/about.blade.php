        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative flex justify-center">
                <div class="relative">
                    ...
                    <div class="absolute {{ $i === 0 ? '-bottom-6 -right-6' : '-top-6 -left-6' }} bg-bg-card/95 border border-border-soft rounded-card p-4 shadow-card max-w-xs backdrop-blur-sm">
            ...
            <div>
                ...
                @if($bio)
                    <div class="prose prose-sm max-w-none prose-p:text-text-muted prose-p:leading-relaxed text-text-muted leading-relaxed mb-8">
                        {!! $bio !!}
                    </div>
                @else
